...
export function Header() {
  ...
  return (
    <header className="bg-surface/80 backdrop-blur-lg border-b border-outline-variant shadow-sm w-full sticky top-0 z-40">
      <div className="flex justify-between items-center w-full px-4 md:px-10 max-w-[1280px] mx-auto h-16">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={openCart}
            className="p-2 text-on-surface-variant hover:text-primary transition-colors rounded-full hover:bg-primary/10 relative"
          >
          ...
          <button
            className="md:hidden p-2 text-on-surface-variant hover:text-primary transition-colors rounded-full hover:bg-primary/10"
